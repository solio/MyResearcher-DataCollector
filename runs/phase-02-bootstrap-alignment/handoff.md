...
- full deterministic suite: `106 passed, 1 xfailed`
...
- The recovered branch is based on `main` and contains no Batch implementation,
  target config, artifacts or batch-only tests.
